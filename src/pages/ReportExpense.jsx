...
const ReportExpense = () => {
    ...
    const [fetchData, {data, isLoading, isFetching, isSuccess}] = useLazyGetReportShipmentExpenseQuery()
    ...
    const columns = [
        ...
        },
        {
            ...
            headerName: t("Type"),
            minWidth: 150,
            valueFormatter : ({value} ) => (expenseTypesObject[value])
            // renderCell: ({value} => ( expenseTypesObject[doItem.expenseType]))
            //   headerAlign: 'center',
            //   align: 'center',
        },
        {
