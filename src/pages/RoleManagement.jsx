...
import { useGetRoleQuery } from "../services/apiSlice";
                ...
                <div>
                    {
                        enableCheckbox && (
                            <Checkbox
                                ...
                                className="mr-2"
                                checked={selectedCheckbox[row.roleName] || false} readOnly />
                        )
                    }
                    {data?.indexOf(row) + 1}
                </div>
                        ...
                        <div className="flex h-full  min-h-[calc(100vh_-_110px)] bg-white ">
                            ...
                            <div className="flex flex-1 flex-col">
                                ...
                                <DataGrid
                                    ...
                                    columns={columns}
                                    selectionModel={selectedRow?.roleName}
                            ...
                            {/* <DeleteRole open={open} setOpen={onDoneDelete} deleteId={selectedRow?.id} /> */}
...
{/* 
                    ...
                    <div className="h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full p-[16px] overflow-auto">
                        <div className="max-w-[700px] p-4 min-h-[50vh] bg-white border m-auto ">
                            {showDetail && (openEdit ? <FormRole selectedItem={selectedRow} refetch={() => { refetch(); setOpenEdit(false) }} triggleSubmit={triggleSubmit} setTriggleSubmit={setTriggleSubmit} setOpenForm={setShowDetail} submitError={() => setTriggleSubmit(false)} /> : <DetailRole detailRow={selectedRow} />)}
                        </div>
                    </div>
                </div>
            </div>
            <FilterRightBar open={openFilter} setOpen={setOpenFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}>
                {/* <FilterRole fleets={[]} filter={criterias} setFilter={updateFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}/> */}
            </FilterRightBar>
            {/* <FormDisplay open={openForm} setOpen={setOpenForm} >
                <FormRole selectedItem={null} refetch={refetch} setTriggleSubmit={setTriggleSubmit} setOpenForm={setOpenForm} />
            </FormDisplay> */}
        </>
    );
};
