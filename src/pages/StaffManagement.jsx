...
import FormStaff from "../components/RttStaff/FormStaff";
import DetailStaff from "../components/RttStaff/DetailStaff";
import FilterStaff from "../components/RttStaff/FilterStaff";
import DeleteStaff from "../components/RttStaff/DeleteStaff";
...
const StaffManagement = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        //       <Tooltip title={t("updateStaff")} placement="top-start" arrow>
        //             <a
    ...
    return (
                ...
                <div className="flex-1 transition-all duration-[300ms]">
                    ...
                    <div className="h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full ">
                        <div className="flex h-full  min-h-[calc(100vh_-_110px)] bg-white ">
                            ...
                            <DeleteStaff open={open} setOpen={onDoneDelete} deleteId={selectedRow?.id} />
                ...
                <div className={(showDetail ? 'w-[600px]' : 'w-[0px]') + " transition-all duration-[300ms]  border-l"}>
                    ...
                    <div className="h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full p-[16px] overflow-auto">
                        <div className="max-w-[700px] p-4 min-h-[50vh] bg-white border m-auto ">
                            {showDetail && (openEdit ? <FormStaff selectedItem={selectedRow} refetch={refetch} triggleSubmit={triggleSubmit} setTriggleSubmit={setTriggleSubmit} setOpenForm={setShowDetail} submitError={() => setTriggleSubmit(false)}  /> : <DetailStaff detailRow={selectedRow} />)}
                        </div>
                    </div>
                </div>
            </div>
            <FilterRightBar open={openFilter} setOpen={setOpenFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}>
                <FilterStaff fleets={[]} filter={criterias} setFilter={updateFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}/>
                {/* <FilterDriver fleets={[]}/> */}
            </FilterRightBar>
            <FormDisplay open={openForm} setOpen={setOpenForm} >
                <FormStaff selectedItem={null} refetch={refetch} setTriggleSubmit={setTriggleSubmit} setOpenForm={setOpenForm} />
        ...
        //       />
        //     </div>
        //     <FormStaff selectedItem={selectedEdit} openForm={openEdit} setOpenForm={setOpenEdit} refetch={refetch}></FormStaff>
        //     <DeleteStaff open={open} setOpen={setOpen} deleteId={selectedItem} />
        //   </div>
        // </div>
    );
};
