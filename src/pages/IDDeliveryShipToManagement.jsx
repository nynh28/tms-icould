...
import FormIDDeliveryShipTo from "../components/IDDeliveryShipTo/FormIDDeliveryShipTo";
import DetailIDDeliveryShipTo from "../components/IDDeliveryShipTo/DetailIDDeliveryShipTo";
import FilterIDDeliveryShipTo from "../components/IDDeliveryShipTo/FilterIDDeliveryShipTo";
import { LoadingButton } from "@mui/lab";
import DeleteIDDeliveryShipTo from "../components/IDDeliveryShipTo/DeleteIDDeliveryShipTo";

const IDDeliveryShipToManagement = () => {
    ...
    const { data, isLoading, isFetching, isSuccess, refetch } =
        useGetIDDeliveryShipToQuery(criterias);
    ...
    const columns = [
        ...
        {
          field: "receiverThaiName",
          headerName: t("receiverThaiName"),
          minWidth: 200,
          //   headerAlign: 'center',
          //   align: 'center',
        },
        ...
        {
          field: "telephoneNumberOne",
          headerName: t("telephoneNumberOne"),
          minWidth: 200,
          //   headerAlign: 'center',
          //   align: 'center',
        },
        ...
        {
          field: "telephoneNumberTwo",
          headerName: t("telephoneNumberTwo"),
          minWidth: 200,
          //   headerAlign: 'center',
          //   align: 'center',
        },
        ...
        {
          field: "timeToUnloadGoods",
          headerName: t("timeToUnloadGoods"),
          minWidth: 200,
          //   headerAlign: 'center',
          //   align: 'center',
        },
        ...
        //       <Tooltip title={t("updateIDDeliveryShipTo")} placement="top-start" arrow>
        //             <a
                ...
                <div className="flex-1 transition-all duration-[300ms]">
                    ...
                    <div className="h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full ">
                        <div className="flex h-full  min-h-[calc(100vh_-_110px)] bg-white ">
                            ...
                            <DeleteIDDeliveryShipTo open={open} setOpen={onDoneDelete} deleteId={selectedRow?.id} />
                ...
                <div className={(showDetail ? 'w-[600px]' : 'w-[0px]') + " transition-all duration-[300ms]  border-l"}>
                    ...
                    <div className="h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full p-[16px] overflow-auto">
                        <div className="max-w-[700px] p-4 min-h-[50vh] bg-white border m-auto ">
                            {showDetail && (openEdit ? <FormIDDeliveryShipTo selectedItem={selectedRow} refetch={() => {refetch(); setOpenEdit(false)}} triggleSubmit={triggleSubmit} setTriggleSubmit={setTriggleSubmit} setOpenForm={setShowDetail} submitError={() => setTriggleSubmit(false)}  /> : <DetailIDDeliveryShipTo detailRow={selectedRow} />)}
                        </div>
                    </div>
                </div>
            </div>
            <FilterRightBar open={openFilter} setOpen={setOpenFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}>
                <FilterIDDeliveryShipTo fleets={[]} filter={criterias} setFilter={updateFilter} triggleFiter={triggleFiter} setTriggleFiter={setTriggleFiter}/>
            </FilterRightBar>
            <FormDisplay open={openForm} setOpen={setOpenForm} >
                <FormIDDeliveryShipTo selectedItem={null} refetch={refetch} setTriggleSubmit={setTriggleSubmit} setOpenForm={setOpenForm} />
            </FormDisplay>
        </>
    );
};

export default IDDeliveryShipToManagement;
