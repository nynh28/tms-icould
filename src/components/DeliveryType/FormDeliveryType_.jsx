...
import { useAddDeliveryTypeMutation,
    useUpdateDeliveryTypeMutation } from "../../services/apiSlice";
...
const FormDeliveryType_ = ({ selectedItem, openForm, setOpenForm, refetch}) => {
                  ...
                  <div className="bg-primary-700 py-6 px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <h2 className="text-lg font-medium capitalize text-white">
                        {t("updateTitle", { field: t("deliveryType") })}
                      </h2>
...
export default FormDeliveryType_;
