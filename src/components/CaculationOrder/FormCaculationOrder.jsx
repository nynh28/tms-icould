...
const FormCaculationOrder = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateCaculationOrderMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddCaculationOrderMutation();
                  ...
                  <div className="bg-primary-700 py-6 px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <h2 className="text-lg font-medium capitalize text-white">
                        {t("updateTitle", { field: t("CaculationOrder") })}
                      </h2>
...
export default FormCaculationOrder;
