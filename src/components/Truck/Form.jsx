...
const AddTruckForm = ({ truckTypes,selectedItem, fleets, triggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [open, setOpen] = useState(false);
    const { masterDatas } = useSelector((state) => state.masterDatas);
    const [addForm, { isLoading: isLoading1 }] = useAddTruckMutation();
    const [addTruck, { isLoading : isLoading2 }] = useAddTruckMutation();
