...
const FormTypeOfCargo = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateTypeOfCargoMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddTypeOfCargoMutation();
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("TypeOfCargo") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("TypeOfCargo") })}
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default FormTypeOfCargo;
