...
const FormCompany = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateRttCompanyMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddRttCompanyMutation();
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("Company") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("Company") })}
                                    </p>
                                </div>
                            </div>
                        </div>
