...
const FormIDAreaMaster = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateIDAreaMasterMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddIDAreaMasterMutation();
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("IDAreaMaster") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("IDAreaMaster") })}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex min-h-0 flex-1 flex-col">
                            ...
                            <div className="relative flex">
                                ...
                                <CustomNumberField
                                    ...
                                    label="provinceCompany"
                                    control={control}
                                    errors={errors.provinceCompany}
                                />
                                <CustomNumberField
                                    name="idSubDistrict"
                                    label="idSubDistrict"
                                    control={control}
                                    errors={errors.idSubDistrict}
                                />
                                <CustomNumberField
                                    name="idDistrict"
                                    label="idDistrict"
                                    control={control}
                                    errors={errors.idDistrict}
                                />
                                <CustomNumberField
                                    name="idProvince"
                                    label="idProvince"
                                    control={control}
                                    errors={errors.idProvince}
                                />
                                <CustomNumberField
                                    name="idVillage"
                                    label="idVillage"
                                    control={control}
                                    errors={errors.idVillage}
                                />
                                <CustomTextField
                                    name="idTems"
                                    label="idTems"
                                    control={control}
                                    errors={errors.idTems}
                                />
                                <CustomNumberField
                                    name="idSpecialArea"
                                    label="idSpecialArea"
                                    control={control}
                                    errors={errors.idSpecialArea}
                                />
                                <CustomTextField
                                    name="idSite"
                                    label="idSite"
                  ...
                  <div className="bg-primary-700 py-6 px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <h2 className="text-lg font-medium capitalize text-white">
                        {t("updateTitle", { field: t("IDAreaMaster") })}
                      </h2>
...
export default FormIDAreaMaster;
