...
const FormUnit = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateUnitMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddUnitMutation();
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("Unit") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("Unit") })}
                                    </p>
                                </div>
                            </div>
                        </div>
