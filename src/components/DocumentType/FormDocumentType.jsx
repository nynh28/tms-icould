...
const FormDocumentType = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateDocumentTypeMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddDocumentTypeMutation();
    ...
    const schema = yup.object().shape({
        ...
        meaning: yup
            .string()
            .required(t("message.validation.required", { field: t("meaning") })),
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("documentType") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("documentType") })}
                                    </p>
                                </div>
                            </div>
                        </div>
                  ...
                  <div className="bg-primary-700 py-6 px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <h2 className="text-lg font-medium capitalize text-white">
                        {t("updateTitle", { field: t("documentType") })}
                      </h2>
