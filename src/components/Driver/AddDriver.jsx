...
const AddDriver = ({ refetch }) => {
  ...
  const schema = yup.object().shape({
    ...
    drivingLicenceNumber: yup
      .string()
      .required(
        t("message.validation.required", { field: t("drivingLicenseNumber") })
      ),
  });
  ...
  const {
    ...
    defaultValues: {
      ...
      drivingLicenceExpirationDate: "2023-01-01T10:00:00Z",
      drivingLicenceClass: 1,
      drivingLicence: "",
      avatar: "",
      groupId: "",
      dateOfBirth: "",
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success(t("message.success.add", { field: t("driver") }));
      refetch();
      reset();
      setOpen(false);
    } catch (error) {
