...
const FilterStaff = ({ fleets, filter, setFilter, triggleFiter, setTriggleFiter }) => {
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="w-full">
                        <TextField
                            ...
                            onChange={(e) => setFilter(prevState => ({
                                ...prevState,
                                PickUpName: e.target.value || null
                            }))}
                        />
                    ...
                    <div className="w-full">
                        <TextField
                            label={t('PickUpNumber')}
                            variant="outlined"
                            name="PickUpNumber"
                            fullWidth
                            onChange={(e) => setFilter(prevState => ({
                                ...prevState,
                                PickUpNumber: e.target.value || null
                            }))}
                        />
