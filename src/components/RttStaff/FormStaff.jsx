...
const FormStaff = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    const { t } = useTranslation();
    const [updateForm, { isLoading: isLoading1 }] = useUpdateStaffMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddStaffMutation();
